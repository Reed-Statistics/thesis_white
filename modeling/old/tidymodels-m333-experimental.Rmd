...
hier_model_fit <- 
  hier_model_spec %>% 
  fit(mean_BIOLIVE_TPA ~ 1 +  mean_forprob + (1 | subsection),
      data = north_rocky_2)


model_df_2 <- data.frame(fitted = hier_model_fit$fit$fitted.values,
           true = north_rocky_2$mean_BIOLIVE_TPA,
           subsection = north_rocky_2$subsection)
