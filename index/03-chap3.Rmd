...
```{r, echo = F, message = F, warning = F, fig.align="center", fig.cap="The Northern Rocky Forest, colored By eco-section"}
...
```{r, message = FALSE, warning=FALSE, echo = FALSE, fig.align="center", fig.retina=4, fig.height=4, fig.width=6, fig.cap="Distribution of total canopy cover in the M333 eco-province (left) and the entire Interior West (right)"}
m333 <- dat_small %>%
...
```{r, echo = F, message = F, warning = F, fig.align="center", fig.cap="Idaho colored by eco-province (left) and eco-section (right)"}
