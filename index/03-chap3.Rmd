...
\end{bmatrix}
$$
We can intuitively think about each $g_{\#j}$ as follows: $g_{1j}$ accounts of for within-area variation, $g_{2j}$ accounts for variation in estimating the regression parameter $\beta$, and $g_{3j}$ accounts for model variance estimation [@mse-area]. 
