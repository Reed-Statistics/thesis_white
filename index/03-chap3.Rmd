...
The dataframe used in this thesis is a joined dataframe derived from two FIA datasets of the Interior West, `spatial` and `response`. The `spatial` dataframe contains 89444 observations and 70 variables, most notably three remotely sensed predictor variables (`forprob`, `forbio`, and `nlcd11`), location information, and ecosubsection. The `forprob` and `forbio` predictors were colleted by FIA [@forbioforprob]. The `nlcd11` variable was collected by the Environmental Protection Agency [@nlcd11].
