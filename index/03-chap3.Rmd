...
```{r, echo = F, message = F, warning = F, fig.align="center", fig.cap="The Northern Rocky Forest, Colored By Ecosection"}
...
```{r, message = FALSE, warning=FALSE, echo = FALSE, fig.align="center", fig.retina=4, fig.height=4, fig.width=6, fig.cap="Predictors in the M333 Province (Top) and the Entire Interior West (Bottom)"}
m333 <- dat_small %>%
  filter(province == "M333")
hist1 <- ggplot(m333) +
  geom_histogram(mapping = aes(x = forprob, y = ..count.. / 1000), color = "black", fill = "steelblue", bins = 30) +
  theme_bw() +
  labs(y = "count (1000's)")
hist2 <- ggplot(m333) +
  geom_histogram(mapping = aes(x = forbio, y = ..count.. / 1000), color = "black", fill = "steelblue", bins = 30) +
  theme_bw() +
  labs(y = "count (1000's)")
hist3 <- ggplot(m333) +
  geom_histogram(mapping = aes(x = nlcd11, y = ..count.. / 1000), color = "black", fill = "steelblue", bins = 30) +
  theme_bw() +
  labs(y = "count (1000's)")
...
```{r, echo = F, message = F, warning = F, fig.align="center", fig.cap="Idaho Colored by Province (Left) and Ecosection (Right)"}
