...
```{r usa-map, fig.align="center", out.width='100%', echo = FALSE, fig.cap="The Interior West region of the United States"}
...
```{r m1, fig.align="center", out.width='65%', echo = FALSE, fig.cap="Mean basal area in Interior West eco-subsections"}
knitr::include_graphics("figure/basal.png")
```
```{r m2, fig.align="center", out.width='65%', echo = FALSE, fig.cap="Mean biomass in Interior West eco-subsections"}
knitr::include_graphics("figure/biomass.png")
```
```{r m3, fig.align="center", out.width='65%', echo = FALSE, fig.cap="Mean tree count per acre in Interior West eco-subsections"}
knitr::include_graphics("figure/count.png")
```
```{r m4, fig.align="center", out.width='65%', echo = FALSE, fig.cap="Mean net volume in Interior West eco-subsections"}
