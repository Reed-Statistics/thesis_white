...
\begin{center}\includegraphics[width=432px]{thesis_files/figure-latex/unnamed-chunk-10-1} \end{center}
...
\caption{Unit-level correlation}\label{fig:unnamed-chunk-14}
\end{figure}
\begin{figure}
...
\caption{Area-level correlation}\label{fig:unnamed-chunk-15}
\end{figure}
...
\caption{Direct and model-based estimates for the unit-level model}\label{fig:unnamed-chunk-16}
\end{figure}
...
\caption{Direct and model-based coefficients of variation for the unit-level model}\label{fig:unnamed-chunk-17}
\end{figure}
