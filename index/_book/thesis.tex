...
Estimator & 25\% & 50\% & 75\%\\
\midrule
Sample Mean & 0.109 & 0.154 & 0.231\\
Post-Stratification & 0.094 & 0.137 & 0.201\\
Area EBLUP & 0.081 & 0.114 & 0.170\\
Unit EBLUP & 0.075 & 0.109 & 0.168\\
Area HB & 0.030 & 0.046 & 0.081\\
\addlinespace
Unit HB & 0.074 & 0.125 & 0.315\\
\bottomrule
\end{longtable}
...
\StringTok{  }\KeywordTok{select}\NormalTok{(PROVINC, SECTION, SUBSECT, geometry)}
\end{Highlighting}
\end{Shaded}
\begin{verbatim}
