...
\begin{center}\includegraphics{thesis_files/figure-latex/unnamed-chunk-17-2} \end{center}
\begin{center}\includegraphics{thesis_files/figure-latex/unnamed-chunk-17-3} \end{center}
