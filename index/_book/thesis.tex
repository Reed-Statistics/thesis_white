...
\caption{\label{tab:unnamed-chunk-5}Analysis of Variance Model (Biomass Response)}\\
\toprule
...
{\centering \includegraphics[width=1\linewidth]{thesis_files/figure-latex/unnamed-chunk-9-1} 
