...
\begin{align}
V(\hat\mu_{y_j}^{HT}) = \frac{1}{n_j-1} \sum_{i \in s_j} \Big(y_{i,j} - \hat\mu_{y_j}^{HT}\Big)^2
\end{align}
...
(more text here)
\begin{center}\includegraphics{thesis_files/figure-latex/unnamed-chunk-17-1} \end{center}
...
\begin{longtable}[t]{lrrrrr}
\caption{\label{tab:unnamed-chunk-18}Quantiles of Percent Relative Difference to the Post-Stratified Estimator}\\
\toprule
Estimator & 0\% & 25\% & 50\% & 75\% & 100\%\\
\midrule
