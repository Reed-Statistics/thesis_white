...
\caption{Distribution of total canopy cover in the M333 eco-province (left) and the entire Interior West (right)}\label{fig:unnamed-chunk-10}
\end{figure}
...
\caption{Idaho colored by eco-province (left) and eco-section (right)}\label{fig:unnamed-chunk-12}
\end{figure}
...
Direct and indirect estimation when auxiliary data is not available or information from auxilary datasets is not wanted. One of the most common direct estimators is the mean:
\begin{align}
