...
For the unit-level hierarchical Bayesian estimator, I start with Equation \eqref{eq:unit-mod} as I did for the unit-level frequentist EBLUP. Now, a hierarchical Bayesian approach can be applied to this equation. To do this I specify Equation \eqref{eq:unit-mod} as a hierarchical Bayesian model:
\begin{align}
...
For the area-level hierarchical Bayesian estimator, I start with Equation \eqref{eq:area-mod}, as was done for the area-level frequentist EBLUP, and apply a hierarchical Bayesian approach to this equation. To do this, I now specify Equation \eqref{eq:area-mod} as a hierarchical Bayesian model:
\begin{align}
