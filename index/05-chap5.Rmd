...
p2 <- res_sf %>%
  ...
  scale_fill_manual(values = c("#BF4C27", "#80BCA2"), na.value = "grey") +
  theme_void() +
  labs(title = "Area HB CV < Area EBLUP CV") +
  theme(legend.position = "none") 
...
p3 <- res_sf %>%
  ...
  scale_fill_manual(values = c("#BF4C27", "#80BCA2"), na.value = "grey") +
  theme_void() +
  labs(title = "Unit HB CV < Post-Strat CV") +
  theme(legend.position = "none") 
...
p4 <- res_sf %>%
  ...
  scale_fill_manual(values = c("#BF4C27", "#80BCA2"), na.value = "grey") +
  theme_void() +
  labs(title = "Unit HB CV < Unit EBLUP CV") +
  theme(legend.position = "none") 
(p3 + p4)
```
