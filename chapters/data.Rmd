...
```{r, echo = FALSE, message = FALSE, warning = FALSE, fig.align="center", cache=TRUE, fig.retina=4}
ggplot() +
...
```{r, echo = FALSE, message = FALSE, warning = FALSE, cache = TRUE, fig.retina = 4, fig.align = 'center', fig.height=6, fig.width=10}
...
These variables are all right-skewed, and all have take value zero quite often. This is because there is lots of land in the Interior West which is not forest, hence our forestry variables should take the value zero. We can see the skewness of the data with a summary of the data and histograms:

```{r, message = FALSE, warning=FALSE, echo = FALSE, fig.align="center", fig.retina=4, fig.height=6, fig.width=10}
library(swfscMisc)
library(tableHTML)
